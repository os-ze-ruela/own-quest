...
import { EMAIL_NOT_VALIDATED, EMAIL_VALIDATED, EXPLORER, GAME, HOME, LANDING_PAGE, LOGIN, NEW_PASSWORD, PLAYGAME, PROFILE, RECOVER_PASSWORD, REGISTER, TEST } from '../core/app-urls';

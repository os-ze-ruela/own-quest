...
import { EMAIL_NOT_VALIDATED, EMAIL_VALIDATED, GAME, HOME, LANDING_PAGE, LOGIN, NEW_PASSWORD, PROFILE, PLAYGAME, RECOVER_PASSWORD, REGISTER, TEST } from '../core/app-urls';
